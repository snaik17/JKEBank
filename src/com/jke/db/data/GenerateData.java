...
public class GenerateData {
	...
	private void generateKeys() throws SQLException {
		if (db.createTable(keysTable, "(KeyID CHAR(8) PRIMARY KEY NOT NULL, NextKey INTEGER)")) {
	...
	protected String getAccountTableColumnString() {
		return "(AccountNumber INTEGER PRIMARY KEY NOT NULL, Balance DOUBLE, Dividends DOUBLE, DividendsETD DOUBLE, Contributions DOUBLE, ContributionsETD DOUBLE, UserName varchar(40) NOT NULL, AccountType VARCHAR(30) NOT NULL, UNIQUE(UserName, AccountType))";
	}
	...
	protected String getContributionsTableColumnString() {
		return "(ContributionID INTEGER PRIMARY KEY NOT NULL, AccountNumber INTEGER, Organization VARCHAR(50), Percentage DOUBLE, Date VARCHAR(20))";
	}
}